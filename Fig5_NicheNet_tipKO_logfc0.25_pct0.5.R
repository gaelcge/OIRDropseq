...
grep("S100", lr_network)

dim(ligand_target_matrix[grep("S100", rownames(ligand_target_matrix)),])
...
seuratObj_receiver= subset(seuratObj_receiver, subset = Cell_SubType == "Tip ECs")
...
setwd("~/projects/def-jsjoyal/gaelcge/Retina/Retina_Mix/Test14_CD31_NORM_OIR_P14_P17_Sirt3/Aligned/SeuratV3/Aligned_Condition/Integrated/NicheNet/TipCells/KO_SenderP14_P17")
...
#  [1] "IL13RA1"   "KDR"       "KIT"       "TNFRSF12A" "TGFBR1"    "BMPR2"    
#  [7] "ACKR3"     "ICAM1"     "OCLN"      "ESAM"      "CNTNAP2"   "ITGB3"    
# [13] "CMKLR1"    "APLNR"     "TEK"       "EDNRB"     "INSR"      "FZD6"     
# [19] "CALCRL"    "RAMP2"     "TIE1"      "LRP5"      "LRP8"      "ATRN"     
# [25] "ACVRL1"    "PTPRB"     "THBD"      "JMJD6"     "PLXNA2"    "EXTL3"    
# [31] "DLG1"      "ANXA6"     "ITPR1"     "ENG"       "LPAR6"     "PCDH7"    
# [37] "NPTN"      "PKD1"      "PCDH1"     "LRP10"     "PTPRG"     "PVR"      
