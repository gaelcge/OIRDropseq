...
setwd("~/projects/def-jsjoyal/gaelcge/Retina/Retina_Mix/Test14_CD31_NORM_OIR_P14_P17_Sirt3/Aligned/SeuratV3/Aligned_Condition/Integrated/NicheNet/TuftCells/KO_SenderP14_P17")
...
condition_oi_receive = "OIR_P14_Sirt3KO"
condition_reference_receive = "OIR_P14_WT" 
...
# [1] "IL11RA1"   "LEPR"      "IL2RG"     "MET"       "IFNGR1"    "TNFRSF10B"
#  [7] "TNFRSF1A"  "FAS"       "IL1RAP"    "SELE"      "JAM2"      "ITGB1"    
# [13] "ITGA5"     "ITGA2B"    "CD47"      "SSTR2"     "CMKLR1"    "APLNR"    
# [19] "TEK"       "IGF1R"     "INSR"      "NPR2"      "NPR3"      "PLD2"     
# [25] "NPR1"      "MERTK"     "FZD6"      "ADIPOR1"   "CALCRL"    "TIE1"     
# [31] "LRP5"      "VLDLR"     "ACVRL1"    "NOTCH4"    "CD151"     "IGF2R"    
# [37] "LPAR4"     "PTPRB"     "ROBO1"     "SORT1"     "ERBB2"     "ERAP1"    
# [43] "PROCR"     "PLAUR"     "JMJD6"     "ATP6AP2"   "TNFRSF19"  "PLXNA2"   
# [49] "ROBO4"     "TFRC"      "GHR"       "CD34"      "EXTL3"     "TLR4"     
# [55] "DLG1"      "ANXA6"     "ABCA1"     "MCC"       "S1PR4"     "S1PR1"    
# [61] "LPAR6"     "CYSLTR1"   "M6PR"      "DAB2"      "TRAM1"     "CUL5"     
# [67] "KCNJ2"     "PKD2"      "SEC63"     "CELSR2"    "NPTN"      "CEACAM1"  
# [73] "CDH13"     "PTPRA"     "PTPRR"    
...
#setting parameters
condition_oi = "OIR_Sirt3KO"
condition_reference = "OIR_WT" 
...
DE_table_mural[grep("APOE", DE_table_mural$gene),]
#     gene      p_val avg_log2FC pct.1 pct.2 p_val_adj
