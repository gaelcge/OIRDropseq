...
setwd("/home/gaelcge/projects/def-jsjoyal/gaelcge/Retina/Retina_Mix/Test14_CD31_NORM_OIR_P14_P17_Sirt3/Aligned/SeuratV3/Aligned_Condition/NORM_WT")
...
DGE.data <- DGE.data %>% dplyr:: select(grep("NORM", names(DGE.data)))
...
FeaturePlot(Seurat_object, features = c("nFeature_RNA", "nCount_RNA", "percent.mt", "pANN_0.25_0.09_311"))
dev.off()
...
DimPlot(Seurat_object, reduction = "umap", label=FALSE, group.by = "DF.classifications_0.25_0.09_311")
dev.off()
...
Seurat_object <- SubsetData(
  ...
  assay = NULL,
  cells = NULL,
  subset.name = "DF.classifications_0.25_0.09_311",
  ident.use = NULL,
  ident.remove = NULL,
  low.threshold = -Inf,
  high.threshold = Inf,
...
new.cluster.ids <- c("ECs",      # cluster 0
                      ...
                      "ECs",     # cluster 4
                      "Rods",     # cluster 5
                      "Neuronal cells",     # cluster 6
                      "ECs",     # cluster 7
                      "ECs",     # cluster 8
                      "Mural cells",     # cluster 9
                      "ECs",     # cluster 10
                      "Neuronal cells",     # cluster 11
                      "ECs",     # cluster 12
                      "Rods",     # cluster 13
                      "Glial cells",     # cluster 14
                      "HBB cells",     # cluster 15
                      "Immune cells",     # cluster 16
                      "Neuronal cells",     # cluster 17
                      "Rods",     # cluster 18
                      "Cones",     # cluster 19
                      "Fibroblasts",     # cluster 20
                      "Lens cells",     # cluster 21
                      "Neuronal cells",     # cluster 22
                      "Immmune cells",     # cluster 23
                      "Mural/RBC cells",     # cluster 24
                      "Mural/glial cells"     # cluster 25
                      )    
...
png(filename="umap.sct.splitedbyCondition.annotated.png", width=5000, height=900, bg = "white", res = 150)
DimPlot(Seurat_object, reduction = "umap", label=TRUE, split.by = "Condition")
dev.off()
